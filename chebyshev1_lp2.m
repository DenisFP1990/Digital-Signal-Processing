function [audio_out,Hs,Hz] = chebyshev1_lp2(audio_in,n_audio_out,fp,fs,Rp,As,metodo)
% Diseño y aplicación de filtro Pasa-Bajos Chebyshev-1 a partir de un audio
% -----------------------------------------
% audio_out = chebyshev1_lp2(audio_in,n_audio_out,fp,fs,Rp,As,metodo);
...
% metodo = metodo de transformacion: 'inv_impulso' 'bilinear'
  ...
  % Impresión de datos del archivo
